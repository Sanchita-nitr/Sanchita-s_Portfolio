...
const Footer = () => {
  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <h1 className=" lg:mt-10 lg:mb-20 mb-10 text-3xl text-center font-serif font-extrabold md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-yellow-200 from-pink-200">Get in Touch</span></h1>
        <div className="lg:mx-10 ">
          <div className="lg:absolute lg:ml-auto lg:right-40 ">
            <p className="lg:text-3xl md:text-4xl text-2xl">Contact Information</p>
            ...
            <a href="https://maps.app.goo.gl/DWfDfXmwexWiTp9R7" target="_blank">
              <img className="lg:size-80 lg:mb-0 md:mb-8 mb-5 " src="NIT.png" alt="NIT" />
            </a>
          </div>
